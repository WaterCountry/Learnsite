    ...
    public class SqlHelper
    {
        ...
        public static int ExecuteNonQuery(CommandType cmdType, string cmdText, params SqlParameter[] commandParameters)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                {
                    string msgtype = "ExecuteNonQuery" + "\r\n\r\n sql语句：" + cmdText;
        ...
        public static DataSet CourseMissionQuery(int Cid)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                try
                {
                    SqlDataAdapter dac = new SqlDataAdapter(strCourse, conn);
                    dac.Fill(ds, "Course");
                    SqlDataAdapter dam = new SqlDataAdapter(strMission, conn);
                    dam.Fill(ds, "Mission");
                ...
                {
                    string msgtype = "CourseMissionQuery";
                    LearnSite.Common.Log.Addlog(msgtype, ex.Message);
                    throw new Exception(ex.Message);
                }
                return ds;
        ...
        /// 不记录异常，以防因新配置时数据库连接不上生成无意义记录
        /// </summary>
        /// <param name="SQLString">计算查询结果语句</param>
        /// <returns>查询结果（object）</returns>
        public static object GetSingleNo(string SQLString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
        ...
        public static object GetSingle(string SQLString)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand(SQLString, connection))
                {
                    ...
                    {
                        connection.Close();
                        string msgtype = "GetSingle查询结果" + "\r\n\r\n sql语句：" + SQLString;
                        LearnSite.Common.Log.Addlog(msgtype, e.Message);
                        throw e;
                    }
                }
            }
        ...
        public static void ExeSqlText(ArrayList arr)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    if (conn.State != ConnectionState.Open)
                        conn.Open();
                    SqlTransaction vtran = conn.BeginTransaction();
                    cmd.Connection = conn;
                    ...
                    try
                    {
                        foreach (string varc in arr)
                        {
                            cmd.CommandText = varc;
                            cmd.ExecuteNonQuery();
                        }
                        vtran.Commit();
                    }
        ...
        /// </summary>
        /// <param name="arr">sql脚本数组</param>
        public static void ExeSqlTextOne(ArrayList arr)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand())
