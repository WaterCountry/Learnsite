...
Blockly.Msg.ARD_ANALOGREAD = "读取模拟引脚#";  // untranslated
Blockly.Msg.ARD_ANALOGREAD_TIP = "返回0到1024之间的值。";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE = "设置模拟引脚#";  // untranslated
Blockly.Msg.ARD_ANALOGWRITE_TIP = "设置指定引脚的值(0~255)";  // untranslated
Blockly.Msg.ARD_BUILTIN_LED = "设置内置Led灯";  // untranslated
Blockly.Msg.ARD_BUILTIN_LED_TIP = "点亮或熄灭Arduino内置Led灯";  // untranslated
...
Blockly.Msg.ARD_DEFINE = "定义";  // untranslated
Blockly.Msg.ARD_DIGITALREAD = "读取数字引脚";  // untranslated
Blockly.Msg.ARD_DIGITALREAD_TIP = "读取数字引脚: 高或低";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE = "设置数字引脚#";  // untranslated
Blockly.Msg.ARD_DIGITALWRITE_TIP = "设置数字引脚: 高或低";  // untranslated
Blockly.Msg.ARD_FUN_RUN_LOOP = "循环 loop()";  // untranslated
Blockly.Msg.ARD_FUN_RUN_SETUP = "初始 setup()";  // untranslated
Blockly.Msg.ARD_FUN_RUN_TIP = "定义 the Arduino setup() and loop() functions.";  // untranslated
Blockly.Msg.ARD_HIGH = "高";  // untranslated
Blockly.Msg.ARD_HIGHLOW_TIP = "设置引脚状态：高或低";  // untranslated
Blockly.Msg.ARD_LOW = "低";  // untranslated
Blockly.Msg.ARD_MAP = "映射";  // untranslated
Blockly.Msg.ARD_MAP_TIP = "映射一个数从[0-1024]到另一个范围";  // untranslated
Blockly.Msg.ARD_MAP_VAL = "值从 [0-";  // untranslated
Blockly.Msg.ARD_NOTONE = "关闭音调引脚#";  // untranslated
Blockly.Msg.ARD_NOTONE_PIN = "静音引脚#";  // untranslated
Blockly.Msg.ARD_NOTONE_PIN_TIP = "设置该引脚静音";  // untranslated
Blockly.Msg.ARD_NOTONE_TIP = "关闭指定引脚上的声音";  // untranslated
Blockly.Msg.ARD_PIN_WARN1 = "引脚%1已经被%2当作%3使用，不能再设置为%4使用";  // untranslated
Blockly.Msg.ARD_PULSEON = "脉冲引脚#";  // untranslated
Blockly.Msg.ARD_PULSEREAD = "读";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT = "超时于";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT_MS = "";  // untranslated
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "脉冲引脚超时检测";  // untranslated
Blockly.Msg.ARD_PULSE_TIP = "检测脉冲引脚的时间周期";  // untranslated
Blockly.Msg.ARD_SERIAL_BPS = "bps";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT = "打印";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "增加新行";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "打印数据到控制台/串行端口作为可读ASCII文本";  // untranslated
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "如果要使用该模块，请在工作区给 %1 添加初始化代码!";  // untranslated
Blockly.Msg.ARD_SERIAL_SETUP = "设置";  // untranslated
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "选择一个特定的串行外设的速度";  // untranslated
Blockly.Msg.ARD_SERIAL_SPEED = ":  设置速度为";  // untranslated
Blockly.Msg.ARD_SERVO_READ = "读取伺服引脚#";  // untranslated
Blockly.Msg.ARD_SERVO_READ_TIP = "读取伺服角度";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE = "设置伺服引脚";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "角度 (0~180)";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TIP = "设置伺服到一个指定角度";  // untranslated
Blockly.Msg.ARD_SERVO_WRITE_TO = "到";  // untranslated
Blockly.Msg.ARD_SETTONE = "设置音调引脚#";  // untranslated
Blockly.Msg.ARD_SPI_SETUP = "设置";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_CONF = "配置:";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "时钟分频";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "低位优先";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_MODE = "SPI模式 (空闲 - 边沿)";  // untranslated
...
Blockly.Msg.ARD_SPI_SETUP_MSBFIRST = "高位优先";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "数据移位";  // untranslated
Blockly.Msg.ARD_SPI_SETUP_TIP = "配置SPI外设";  // untranslated
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "发送一个SPI消息到指定从属设备并获取数据";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_NONE = "无";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "从属引脚";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_TIP = "发送一个SPI消息到指定从属设备";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_VAL = "转换";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "如果要使用该模块，请在工作区给 %1 添加初始化代码!";  // untranslated
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "旧引脚的值 %1 已经不可再用";  // untranslated
Blockly.Msg.ARD_STEPPER_COMPONENT = "步进";  // untranslated
Blockly.Msg.ARD_STEPPER_DEFAULT_NAME = "MyStepper";  // untranslated
Blockly.Msg.ARD_STEPPER_MOTOR = "步进电机:";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN1 = "引脚1#";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN2 = "引脚2#";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN3 = "引脚3#";  // untranslated
Blockly.Msg.ARD_STEPPER_PIN4 = "引脚4#";  // untranslated
Blockly.Msg.ARD_STEPPER_REVOLVS = "每转多少步数";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP = "设置步进电机";  // untranslated
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "配置步进电机引脚和其他设置";  // untranslated
Blockly.Msg.ARD_STEPPER_SPEED = "设置rpm转数";  // untranslated
Blockly.Msg.ARD_STEPPER_STEP = "移动步进电机";  // untranslated
Blockly.Msg.ARD_STEPPER_STEPS = "步数";  // untranslated
Blockly.Msg.ARD_STEPPER_STEP_TIP = "步进电机转动指定步数";  // untranslated
Blockly.Msg.ARD_TIME_DELAY = "等待";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICROS = "微秒";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "等待指定时间（微秒）";  // untranslated
Blockly.Msg.ARD_TIME_DELAY_TIP = "等待指定时间（毫秒）";  // untranslated
Blockly.Msg.ARD_TIME_INF = "等待永远 (停止程序)";  // untranslated
Blockly.Msg.ARD_TIME_INF_TIP = "等待永远，停止程序";  // untranslated
Blockly.Msg.ARD_TIME_MICROS = "当前运行时间 (微秒)";  // untranslated
Blockly.Msg.ARD_TIME_MICROS_TIP = "返回Arduino电路板当前程序运行时间，必须以长整数存储（微秒）";  // untranslated
Blockly.Msg.ARD_TIME_MILLIS = "当前运行时间 (毫秒)";  // untranslated
Blockly.Msg.ARD_TIME_MILLIS_TIP = "返回Arduino电路板当前程序运行时间，必须以长整数存储（毫秒）";  // untranslated
Blockly.Msg.ARD_TIME_MS = "毫秒";  // untranslated
Blockly.Msg.ARD_TONEFREQ = "频率";  // untranslated
Blockly.Msg.ARD_TONE_FREQ = "频率";  // untranslated
Blockly.Msg.ARD_TONE_PIN = "音调引脚#";  // untranslated
Blockly.Msg.ARD_TONE_PIN_TIP = "设置引脚音调";  // untranslated
Blockly.Msg.ARD_TONE_TIP = "指定频率范围内的音调（31 - 65535）";  // untranslated
Blockly.Msg.ARD_TONE_WARNING = "频率必须指定范围内（31 - 65535）";  // untranslated
Blockly.Msg.ARD_TYPE_ARRAY = "数组";  // untranslated
Blockly.Msg.ARD_TYPE_BOOL = "布尔型";  // untranslated
Blockly.Msg.ARD_TYPE_CHAR = "字符";  // untranslated
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "子语句丢失";  // untranslated
Blockly.Msg.ARD_TYPE_DECIMAL = "浮点数";  // untranslated
Blockly.Msg.ARD_TYPE_LONG = "长整数";  // untranslated
Blockly.Msg.ARD_TYPE_NULL = "空";  // untranslated
Blockly.Msg.ARD_TYPE_NUMBER = "整数";  // untranslated
Blockly.Msg.ARD_TYPE_SHORT = "短整数";  // untranslated
Blockly.Msg.ARD_TYPE_TEXT = "字符串";  // untranslated
Blockly.Msg.ARD_TYPE_UNDEF = "未定义";  // untranslated
Blockly.Msg.ARD_VAR_AS = "数据类型为";  // untranslated
Blockly.Msg.ARD_VAR_AS_TIP = "将值设置为指定类型";  // untranslated
...
Blockly.Msg.LOGIC_TERNARY_CONDITION = "检查条件";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "检查“  ”中的条件。如果条件为真，则返回“if true”的值，否则，则返回“if false”的值。";
...
Blockly.Msg.RENAME_INSTANCE = "重命名实例...";  // untranslated
Blockly.Msg.RENAME_INSTANCE_TITLE = "重命名所有 '%1' 实例为:";  // untranslated
