...
(function(ext) {
 ...
 ext.connectHWA = function(hw, pin) {
    hwList.add(hw, pin);
  };
  ...
  var blocks = {
    en: [
      ...
      [' ', 'connect %m.hwIn to analog %n', 'connectHWA', 'rotation knob', 0],
      ['-'],
      ...
      [' ', 'set analog %n to %n%', 'analogWrite', 3, 100],
      ['-'],
  ...
  var menus = {
    en: {
      ...
      hwIn: ['analog component','rotation knob', 'light sensor', 'temperature sensor'],
      hwOut: ['digital component' , 'led A', 'led B', 'led C', 'led D', 'button A', 'button B', 'button C', 'button D', 'servo A', 'servo B', 'servo C', 'servo D'],
