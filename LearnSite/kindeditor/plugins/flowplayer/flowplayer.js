...
flowplayer(function (e, o) {
    ...
    if ("file:" == location.protocol && (f = "localhost"), e.load.ed = 1, n.hostname = f, n.origin = i || location.href, i && l(o, "is-embedded"), "string" == typeof s && (s = s.split(/,\s*/)), s && "function" == typeof key_check && key_check(s, f)) {
        if (n.logo) {
            ...
            i && (m.href = m.href || i),
            n.embed && n.embed.popup && (m.target = "_blank");
            var y = p("img", {
                src: h
            });
            m.appendChild(y),
        ...
        e.on("pause resume finish unload ready", function (e, a) {
            var l = -1;
            if (a.video.src)
                for (var n = [["org", "flowplayer", "drive"], ["org", "flowplayer", "my"], ["org", "flowplayer", "cdn"], ["com", "flowplayer", "cdn"]], t = 0; t < n.length && (l = a.video.src.indexOf("://" + n[t].reverse().join(".")), -1 === l); t++);
            if (/pause|resume/.test(e.type) && "flash" != a.engine.engineName && 4 != l && 5 != l) {
                ...
                for (var i in p)
                    p.hasOwnProperty(i) && (m.style[i] = p[i]);
                a.load.ed = r(m) ,
                a.load.ed || a.pause()   //4567中文
            } else
