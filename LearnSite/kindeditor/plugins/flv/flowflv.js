            ...
            var dialog = self.createDialog({
                ...
                yesBtn: {
                    ...
                    click: function (e) {
                        ...
                        var srcjs = "../kindeditor/plugins/flowplayer/flowplayer.js";
                        ...
                        var html = [
						'<link rel="stylesheet" href="../kindeditor/plugins/flowplayer/skin/skin.css" />',
                        ...
                        '<div id="' + divplayer + '" style="width: ' + width + 'px; height:' + height + 'px;" class="flowplayer"  data-ratio="0.4167">',
						' <video loop ><source type="video/mp4" src="' + url + '"></video>',						
						'</div>',
                        '</div><br>\r\n'
						].join('');
                        //alert(html);
