 ...
 */
EditorUi.prototype.formatEnabled = false;//周
 ...
 * screen widths <= 640px.
 */
EditorUi.prototype.hsplitPosition = (screen.width <= 640) ? 118 : ((urlParams['sidebar-entries'] != 'large') ? 80 : 240); //周
...
EditorUi.prototype.showShapePicker = function(x, y, source, callback, direction)
{
	...
	if (cells != null && cells.length > 0)
	{
		...
		// Do not place entry under pointer for touch devices//周
		div.className = 'geToolbarContainer geSidebarContainer geSidebar';
		div.style.cssText = 'position:absolute;left:' + x + 'px;top:' + y +
			'px;width:100px;border-radius:6px;padding:4px;text-align:right;' +
...
/**
 * Creates a temporary graph instance for rendering off-screen content.//周
 */
EditorUi.prototype.getCellsForShapePicker = function(cell)
{
	...
	return [(cell != null) ? this.editor.graph.cloneCell(cell) :
		createVertex('text;html=1;align=center;verticalAlign=middle;resizable=0;points=[];autosize=1;', 40, 20, '文字'),
		createVertex('rounded=1;whiteSpace=wrap;html=1;arcSize=50;', 120, 60),
